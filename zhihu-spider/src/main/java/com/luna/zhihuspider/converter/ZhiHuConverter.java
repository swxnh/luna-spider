package com.luna.zhihuspider.converter;
...
import com.luna.zhihuspider.spider.pojo.columns.Author;
import com.luna.zhihuspider.spider.pojo.columns.ColumnBO;
import com.luna.zhihuspider.spider.pojo.papers.*;
...
public class ZhiHuConverter {
    ...
    public Paper toPaper(PaperBO paperBO) {
        ...
        com.luna.zhihuspider.spider.pojo.papers.Author author = paperBO.getAuthor();
        if (author != null) {
