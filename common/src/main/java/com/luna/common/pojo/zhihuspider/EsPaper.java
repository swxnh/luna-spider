package com.luna.common.pojo.zhihuspider;
...
@Data
@Setting(settingPath = "es-setting.json",replicas = 0,refreshInterval = "600s")
public class EsPaper implements Serializable {
     ...
     * 版权保护
     */
    @Field(index = false,type = FieldType.Text,analyzer = "ik_max_word")
